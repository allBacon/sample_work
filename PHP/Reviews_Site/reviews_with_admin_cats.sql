...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2016 at 09:17 PM
...
ALTER TABLE `make`
  ADD PRIMARY KEY (`id`);
ALTER TABLE `make` ADD FULLTEXT KEY `manufacturer` (`manufacturer`);
...
ALTER TABLE `model` ADD FULLTEXT KEY `model_name` (`model_name`);
...
ALTER TABLE `review` ADD FULLTEXT KEY `title` (`title`);
ALTER TABLE `review` ADD FULLTEXT KEY `review_content` (`review_content`);
ALTER TABLE `review` ADD FULLTEXT KEY `review_meta` (`review_meta`);
ALTER TABLE `review` ADD FULLTEXT KEY `title_2` (`title`);
ALTER TABLE `review` ADD FULLTEXT KEY `review_content_2` (`review_content`);
ALTER TABLE `review` ADD FULLTEXT KEY `review_meta_2` (`review_meta`);
ALTER TABLE `review` ADD FULLTEXT KEY `title_3` (`title`);
